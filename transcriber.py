...
class Transcriber:
    def __init__(self, model_name="medium.en"):
        # Initializes the transcriber with the specified mode
...
if __name__ == "__main__":
    ...
    transcribed_text = transcriber.transcribe("/Users/jacksiegel/Desktop/openai-whisper-cpu/whisper/tests/jfk.flac")
